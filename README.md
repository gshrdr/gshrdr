...
- I'm learning the following web-development technologies: Python, React, JavaScript, HTML5, CSS3, & Three.JS
- You can reach me via my [contact form](https://www.gavinshr.com/#contact)  
- If you want to learn how to code + publish your own website you can follow my [tutorial](https://medium.com/@shrader.gavin/how-to-code-and-publish-your-first-website-in-2022-with-no-prior-experience-e5facba050e9)
